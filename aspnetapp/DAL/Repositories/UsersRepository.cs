    ...
    TableFetcher fetcher)
{
    ...
    public async Task<int?> CreateUserAsync(User user)
    {
        var query = new StringBuilder()
            .Append(
                "INSERT INTO users (user_name, first_name, last_name, email, password,  is_verified, last_login_at, email_reset_token) ")
            .Append(
                "VALUES               (@userName, @firstName, @lastName, @email, @password,  @isVerified, @last_login_at, @email_reset_token) Returning user_id");
        var parameters = new Dictionary<string, object>
        {
            ...
            { "@email_reset_token", user.EmailResetToken }
